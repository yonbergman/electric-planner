    ...
    <div className="w-64 bg-white h-full flex flex-col border-r border-slate-200 shadow-sm">
            ...
            {editingId === room.id ? (
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <RoomIcon size={16} className={selectedRoomId === room.id ? 'text-indigo-200' : 'text-slate-400'} />
      ...
      <div className="p-3 border-t border-slate-100">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors"
        >
          <Plus size={18} />
          Add Room
        </button>
