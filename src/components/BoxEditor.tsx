        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-silver-500 focus:border-transparent placeholder:text-slate-400"
              autoFocus
              autoComplete="off"
              data-1p-ignore
            />
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 bg-silver-500 text-white rounded-lg font-medium hover:bg-silver-600 shadow-md shadow-silver-500/30 transition-all"
            >
              {box ? 'Save' : 'Add'}
            </button>
          </div>
